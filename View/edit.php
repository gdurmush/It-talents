...
<form action="index.php?target=User&action=edit" method="post">
    ...
    <div class="form-group">
        ...
        <input name="email" type="email" value="<?php echo $user->email ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
    ...
    <div class="form-group">
        <label >Age</label>
        <input type="number" name="age" value="<?php echo $user->age ?>" class="form-control" min="0" max="100" required>

    </div>
    <div class="form-group">
        <label >Phone number</label>
        <input type="number" name="phone_number" value="<?php echo $user->phone_number ?>" class="form-control" placeholder="0888888888" required>
