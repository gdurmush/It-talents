...
<a href="index.php?target=address&action=newAddress"><button name="addAddress" class="btn btn-primary">Add address</button></a><br>
<hr>
<a href="index.php?target=order&action=show"><button>My Orders</button></a><br>
<hr>
<a href="index.php?target=product&action=myRated"><button class="btn btn-primary">My rated products</button></a><br>
<hr>
